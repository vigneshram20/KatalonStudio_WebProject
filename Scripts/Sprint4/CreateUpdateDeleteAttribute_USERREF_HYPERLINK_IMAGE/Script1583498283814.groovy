...
if(DataType.equals("USER_REF") || DataType.equals("HYPERLINK") || DataType.equals("IMAGE"))
{
	//Verify
	if(AttributeType.equals('USER_REF'))
	{
		'Verify User Roles'
	...
	'Select Checkbox'
	WebUI.click(findTestObject('Sprint4/label_CheckboxPopup', [('Symbol') : UserRoles]))

	'Click Save button'
	WebUI.click(findTestObject('Object Repository/Sprint4/button_Save'))

	'Verify Selected Currency Symbol'
	WebUI.click(findTestObject('Sprint4/li_ItemSelected', [('Symbol') : UserRoles]))
	}
	if(AttributeType.equals("IMAGE"))
	{
		'Provide Element Width'
	...
	WebUI.click(findTestObject('Sprint4/li_ItemSelected', [('Symbol') : SupportedType]))
	}
	...
	{
		'Verify User Roles'
		WebUI.verifyElementPresent(findTestObject('Sprint4/li_ItemSelected', [('Symbol') : UserRoles]))
	}
	
	if(AttributeType.equals("IMAGE"))
	{
		'Verify Supported Type Symbol'
		not_run:WebUI.click(findTestObject('Sprint4/li_ItemSelected', [('Symbol') : SupportedType]))
		
		'Provide Element Width'
		WebUI.verifyElementAttributeValue(findTestObject('Object Repository/Sprint4/input_Text Box Width_elementWidth'),'value', ElementWidth,0)
		
		'Provide Element Height'
		WebUI.verifyElementAttributeValue(findTestObject('Object Repository/Sprint4/input_Text Box Height_elementHeight'),'value', ElementHeight,0)
		
		'Provide Fit To Size'
		not_run: WebUI.verifyElementPresent(findTestObject('Object Repository/Sprint4/radio_VerifyGlobalParameterized', [('attribute') : 'fitToSize'
			, ('input') : FitToSize]), 0)
		
		'Verify Max File Size'
		not_run:WebUI.verifyElementAttributeValue(findTestObject('Object Repository/Sprint4/input_MaxFileSize'),'value',MaxFileSize,0)
	}
