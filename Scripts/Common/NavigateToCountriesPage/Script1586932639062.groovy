...
'Click Countries sub menu'
WebUI.click(findTestObject('Sprint1/LandingPage/a_Countries'))

WebUI.delay(1)

'Verify Countries Page Title'
WebUI.verifyElementPresent(findTestObject('Sprint5/divPageHeader_Countries'), 0)
