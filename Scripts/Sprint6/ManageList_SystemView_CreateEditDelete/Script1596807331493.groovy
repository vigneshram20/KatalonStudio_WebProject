...
WebUI.callTestCase(findTestCase('Sprint2/linkTestCases/linkTestCase_EditView'), [('viewName') : viewName, ('viewType') : viewType,('editedAttributes'):editedAttributes,('sortByGroupBy'):'No'], FailureHandling.STOP_ON_FAILURE)
