...
WebUI.callTestCase(findTestCase('Sprint6/linkTestCases/linkTestCase_CreateCustomView'), [('viewName') : viewName], FailureHandling.STOP_ON_FAILURE)
...
not_run: WebUI.verifyElementPresent(findTestObject('Sprint6/button_paremeterized_ViewName', [('viewName') : viewName]), 
    0)

WebUI.callTestCase(findTestCase('Sprint6/linkTestCases/linkTestCase_DeleteCustomView'), [('viewName') : viewName], FailureHandling.STOP_ON_FAILURE)
