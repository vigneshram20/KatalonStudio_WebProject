...
WebUI.click(findTestObject('Object Repository/Sprint6/label_PB Business Administrator'))
...
WebUI.verifyElementPresent(findTestObject('Sprint6/div_td_permission_table_verification', [('attributeName') : attributeName
            , ('paramName') : paramName, ('permission') : 'Create', ('roleName') : 'PB Business Administrator']), 0)
