...
WebUI.verifyElementText(findTestObject('Sprint1/Create Season/header_CreateSeasonOverlay'), Create_Season_Modal_Title)

'Verify Header note text'
WebUI.verifyElementText(findTestObject('Sprint1/Create Season/text1_CreateSeasonOverlay'), Create_Season_Title_Note)
...
WebUI.verifyElementVisible(findTestObject('Sprint1/Create Season/label_Brand'))

'Click Brand dropdown'
WebUI.click(findTestObject('Sprint1/Create Season/Brand Select dropdown'))

'Click Brand Label'
WebUI.click(findTestObject('Sprint1/Create Season/label_Brand'), FailureHandling.STOP_ON_FAILURE)

'Click Brand dropdown'
WebUI.sendKeys(findTestObject('Sprint1/Create Season/Brand Select dropdown'), Keys.chord(Keys.TAB))

'Verify Brand field error message'
WebUI.verifyElementText(findTestObject('Sprint1/Create Season/errorText_BrandField'), Field_Required_Error)

'Click Season label'
WebUI.click(findTestObject('Sprint1/Create Season/label_Season'))

'Click Season dropdown'
WebUI.click(findTestObject('Sprint1/Create Season/Season Select dropdown'))

'Click Season dropdown'
WebUI.sendKeys(findTestObject('Sprint1/Create Season/Season Select dropdown'), Keys.chord(Keys.TAB))
...
WebUI.verifyElementText(findTestObject('Sprint1/Create Season/errorText_SeasonField'), Field_Required_Error)

'Click Year Label'
WebUI.click(findTestObject('Sprint1/Create Season/label_Year'))

'Click Year dropdown'
WebUI.click(findTestObject('Sprint1/Create Season/Year Select dropdown'))

'Click Year dropdown'
WebUI.sendKeys(findTestObject('Sprint1/Create Season/Year Select dropdown'), Keys.chord(Keys.TAB))

'Click Sub section Title- General Attributes'
WebUI.click(findTestObject('Sprint1/Create Season/subSection_title_General Attributes'))

'Verify Year Field error message'
WebUI.verifyElementText(findTestObject('Sprint1/Create Season/errorText_YearField'), Field_Required_Error)
...
WebUI.click(findTestObject('Sprint1/Create Season/input__in_store_launch_start_date'))
...
WebUI.click(findTestObject('Sprint1/Create Season/input__in_store_launch_end_date'))
