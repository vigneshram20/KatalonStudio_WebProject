...
WebUI.enhancedClick(findTestObject('Object Repository/Sprint6/button_Manage Permissions'))
...
WebUI.enhancedClick(findTestObject('Object Repository/Sprint6/img_Attribute Permissions_img-icon'))
...
WebUI.enhancedClick(findTestObject('Sprint6/label_parameterized', [('param') : paramName]))
...
WebUI.enhancedClick(findTestObject('Sprint6/label_parameterized', [('param') : RoleName]))
