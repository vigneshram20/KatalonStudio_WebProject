...
WebUI.enhancedClick(findTestObject('Object Repository/Sprint5/a_Create New Lading Port'))
...
WebUI.verifyElementPresent(findTestObject('Sprint5/p_parameterized', [('text') : lm.get("Name")]), 0)
...
WebUI.verifyElementPresent(findTestObject('Sprint5/p_Parameterized has been deleted', [('text') : lm.get("Name")]), 
    0)
